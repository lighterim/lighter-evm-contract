...
contract LocalTakeIntentTest is Permit2Signature {
    ...
    function setUp() public {
        ...
        lighterAccount.authorizeOperator(address(waypoint), true);
        lighterAccount.authorizeOperator(address(this), true);
    ...
    function createEscrow(ISettlerBase.EscrowParams memory escrowParams) public {
        lighterAccount.makesurePendingTx(escrowParams.seller, escrowParams.buyer, 0, 0);
