...
export action2Params=$(cast abi-encode "((uint256,address,uint256,uint256,uint256,address,address,uint256,bytes32,bytes32,bytes32,address,uint256),bytes)" $escrowParms $relayerSig)
...
export action3Params=$(cast abi-encode "(((address,uint256),uint256,uint256),(address,uint256),(address,(uint256,uint256),uint64,bytes32,bytes32,bytes32,uint256),bytes)" $permit $transferDetails $intentParams $sig)
